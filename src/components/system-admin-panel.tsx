...
type SystemData = {
  ...
  health: { database: { ready: boolean }; storage: { ready: boolean; reason: string }; email: { configured: boolean; reachable: boolean; reason: string } };
